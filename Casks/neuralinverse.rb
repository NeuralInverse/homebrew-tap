cask "neuralinverse" do
  ...
  on_arm do
    url "https://github.com/NeuralInverse/neuralinverse/releases/download/v#{version}/neuralinverse-darwin-arm64",
        verified: "github.com/NeuralInverse/neuralinverse/"
  ...
  on_intel do
    url "https://github.com/NeuralInverse/neuralinverse/releases/download/v#{version}/neuralinverse-darwin-x64",
        verified: "github.com/NeuralInverse/neuralinverse/"
